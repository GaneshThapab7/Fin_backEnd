...
// @ts-ignore
import { GetStandingInstructionsResponse } from '../apache-fineract-client/models/getStandingInstructionsResponse';
// @ts-ignore
import { GetStandingInstructionsStandingInstructionIdResponse } from '../apache-fineract-client/models/getStandingInstructionsStandingInstructionIdResponse';
// @ts-ignore
import { GetStandingInstructionsTemplateResponse } from '../apache-fineract-client/models/getStandingInstructionsTemplateResponse';
// @ts-ignore
import { PostStandingInstructionsRequest } from '../apache-fineract-client/models/postStandingInstructionsRequest';
// @ts-ignore
import { PostStandingInstructionsResponse } from '../apache-fineract-client/models/postStandingInstructionsResponse';
// @ts-ignore
import { PutStandingInstructionsStandingInstructionIdRequest } from '../apache-fineract-client/models/putStandingInstructionsStandingInstructionIdRequest';
// @ts-ignore
import { PutStandingInstructionsStandingInstructionIdResponse } from '../apache-fineract-client/models/putStandingInstructionsStandingInstructionIdResponse';
...
export class StandingInstructionsService {
    ...
    public create5(postStandingInstructionsRequest: PostStandingInstructionsRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<PostStandingInstructionsResponse>(`${this.configuration.basePath}/standinginstructions`,
    ...
    public retrieveAll19(sqlSearch?: string, externalId?: string, offset?: number, limit?: number, orderBy?: string, sortOrder?: string, transferType?: number, clientName?: string, clientId?: number, fromAccountId?: number, fromAccountType?: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<GetStandingInstructionsResponse>(`${this.configuration.basePath}/standinginstructions`,
            {
                context: localVarHttpContext,
    ...
    public retrieveOne10(standingInstructionId: number, sqlSearch?: string, externalId?: string, offset?: number, limit?: number, orderBy?: string, sortOrder?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<GetStandingInstructionsStandingInstructionIdResponse>(`${this.configuration.basePath}/standinginstructions/${encodeURIComponent(String(standingInstructionId))}`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
    ...
    public template6(fromOfficeId?: number, fromClientId?: number, fromAccountId?: number, fromAccountType?: number, toOfficeId?: number, toClientId?: number, toAccountId?: number, toAccountType?: number, transferType?: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<GetStandingInstructionsTemplateResponse>(`${this.configuration.basePath}/standinginstructions/template`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
    ...
    public update9(standingInstructionId: number, command?: string, putStandingInstructionsStandingInstructionIdRequest?: PutStandingInstructionsStandingInstructionIdRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.put<PutStandingInstructionsStandingInstructionIdResponse>(`${this.configuration.basePath}/standinginstructions/${encodeURIComponent(String(standingInstructionId))}`,
