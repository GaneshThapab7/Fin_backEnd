...
// @ts-ignore
import { GetJobsJobIDJobRunHistoryResponse } from '../apache-fineract-client/models/getJobsJobIDJobRunHistoryResponse';
// @ts-ignore
import { GetJobsResponse } from '../apache-fineract-client/models/getJobsResponse';
// @ts-ignore
import { PutJobsJobIDRequest } from '../apache-fineract-client/models/putJobsJobIDRequest';
...
export class SCHEDULERJOBService {
     ...
     */
    public executeJob(jobId: number, command?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<any>;
    public executeJob(jobId: number, command?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<HttpResponse<any>>;
    public executeJob(jobId: number, command?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<HttpEvent<any>>;
    public executeJob(jobId: number, command?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<any>(`${this.configuration.basePath}/jobs/${encodeURIComponent(String(jobId))}`,
            null,
            {
    ...
    public retrieveAll8(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<Array<GetJobsResponse>>(`${this.configuration.basePath}/jobs`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public retrieveHistory(jobId: number, offset?: number, limit?: number, orderBy?: string, sortOrder?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<GetJobsJobIDJobRunHistoryResponse>(`${this.configuration.basePath}/jobs/${encodeURIComponent(String(jobId))}/runhistory`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
    ...
    public retrieveOne5(jobId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<GetJobsResponse>(`${this.configuration.basePath}/jobs/${encodeURIComponent(String(jobId))}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public updateJobDetail(jobId: number, putJobsJobIDRequest: PutJobsJobIDRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.put<any>(`${this.configuration.basePath}/jobs/${encodeURIComponent(String(jobId))}`,
            putJobsJobIDRequest,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
