...
// @ts-ignore
import { GetSearchResponse } from '../apache-fineract-client/models/getSearchResponse';
// @ts-ignore
import { PostAdhocQuerySearchRequest } from '../apache-fineract-client/models/postAdhocQuerySearchRequest';
// @ts-ignore
import { PostAdhocQuerySearchResponse } from '../apache-fineract-client/models/postAdhocQuerySearchResponse';
...
export class SearchAPIService {
    ...
    public advancedSearch(postAdhocQuerySearchRequest: PostAdhocQuerySearchRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<Array<PostAdhocQuerySearchResponse>>(`${this.configuration.basePath}/search/advance`,
    ...
    public retrieveAdHocSearchQueryTemplate(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<GetSearchResponse>(`${this.configuration.basePath}/search/template`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public searchData(query?: string, resource?: string, exactMatch?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<Array<GetSearchResponse>>(`${this.configuration.basePath}/search`,
            {
                context: localVarHttpContext,
