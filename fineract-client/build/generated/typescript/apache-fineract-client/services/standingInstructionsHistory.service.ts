...
// @ts-ignore
import { GetStandingInstructionRunHistoryResponse } from '../apache-fineract-client/models/getStandingInstructionRunHistoryResponse';
...
export class StandingInstructionsHistoryService {
    ...
    public retrieveAll20(sqlSearch?: string, externalId?: string, offset?: number, limit?: number, orderBy?: string, sortOrder?: string, transferType?: number, clientName?: string, clientId?: number, fromAccountId?: number, fromAccountType?: number, locale?: string, dateFormat?: string, fromDate?: object, toDate?: object, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<GetStandingInstructionRunHistoryResponse>(`${this.configuration.basePath}/standinginstructionrunhistory`,
            {
