...
// @ts-ignore
import { DeleteFixedDepositAccountsAccountIdResponse } from '../apache-fineract-client/models/deleteFixedDepositAccountsAccountIdResponse';
// @ts-ignore
import { GetFixedDepositAccountsAccountIdResponse } from '../apache-fineract-client/models/getFixedDepositAccountsAccountIdResponse';
// @ts-ignore
import { GetFixedDepositAccountsResponse } from '../apache-fineract-client/models/getFixedDepositAccountsResponse';
// @ts-ignore
import { GetFixedDepositAccountsTemplateResponse } from '../apache-fineract-client/models/getFixedDepositAccountsTemplateResponse';
// @ts-ignore
import { PostFixedDepositAccountsAccountIdResponse } from '../apache-fineract-client/models/postFixedDepositAccountsAccountIdResponse';
// @ts-ignore
import { PostFixedDepositAccountsRequest } from '../apache-fineract-client/models/postFixedDepositAccountsRequest';
// @ts-ignore
import { PostFixedDepositAccountsResponse } from '../apache-fineract-client/models/postFixedDepositAccountsResponse';
// @ts-ignore
import { PutFixedDepositAccountsAccountIdRequest } from '../apache-fineract-client/models/putFixedDepositAccountsAccountIdRequest';
// @ts-ignore
import { PutFixedDepositAccountsAccountIdResponse } from '../apache-fineract-client/models/putFixedDepositAccountsAccountIdResponse';
...
export class FixedDepositAccountService {
    ...
    public accountClosureTemplate(accountId: number, command?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<string>(`${this.configuration.basePath}/fixeddepositaccounts/${encodeURIComponent(String(accountId))}/template`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public delete14(accountId: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<DeleteFixedDepositAccountsAccountIdResponse>;
    public delete14(accountId: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<DeleteFixedDepositAccountsAccountIdResponse>>;
    public delete14(accountId: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<DeleteFixedDepositAccountsAccountIdResponse>>;
    public delete14(accountId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (accountId === null || accountId === undefined) {
        ...
        return this.httpClient.delete<DeleteFixedDepositAccountsAccountIdResponse>(`${this.configuration.basePath}/fixeddepositaccounts/${encodeURIComponent(String(accountId))}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public getFixedDepositTemplate(officeId?: number, staffId?: number, dateFormat?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/vnd.ms-excel', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.configuration.basePath}/fixeddepositaccounts/downloadtemplate`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
    ...
    public getFixedDepositTransactionTemplate(officeId?: number, dateFormat?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/vnd.ms-excel', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.configuration.basePath}/fixeddepositaccounts/transaction/downloadtemplate`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
    ...
    public handleCommands4(accountId: number, body: object, command?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<PostFixedDepositAccountsAccountIdResponse>(`${this.configuration.basePath}/fixeddepositaccounts/${encodeURIComponent(String(accountId))}`,
            body,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
    ...
    public postFixedDepositTemplate(dateFormat?: string, locale?: string, uploadedInputStream?: Blob, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<string>(`${this.configuration.basePath}/fixeddepositaccounts/uploadtemplate`,
    ...
    public postFixedDepositTransactionTemplate(dateFormat?: string, locale?: string, uploadedInputStream?: Blob, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<string>(`${this.configuration.basePath}/fixeddepositaccounts/transaction/uploadtemplate`,
            localVarConvertFormParamsToString ? localVarFormParams.toString() : localVarFormParams,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
    ...
    public retrieveAll29(paged?: boolean, offset?: number, limit?: number, orderBy?: string, sortOrder?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<Array<GetFixedDepositAccountsResponse>>(`${this.configuration.basePath}/fixeddepositaccounts`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public retrieveOne18(accountId: number, staffInSelectedOfficeOnly?: boolean, chargeStatus?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<GetFixedDepositAccountsAccountIdResponse>;
    public retrieveOne18(accountId: number, staffInSelectedOfficeOnly?: boolean, chargeStatus?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<GetFixedDepositAccountsAccountIdResponse>>;
    public retrieveOne18(accountId: number, staffInSelectedOfficeOnly?: boolean, chargeStatus?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<GetFixedDepositAccountsAccountIdResponse>>;
    public retrieveOne18(accountId: number, staffInSelectedOfficeOnly?: boolean, chargeStatus?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (accountId === null || accountId === undefined) {
        ...
        return this.httpClient.get<GetFixedDepositAccountsAccountIdResponse>(`${this.configuration.basePath}/fixeddepositaccounts/${encodeURIComponent(String(accountId))}`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
    ...
    public submitApplication(postFixedDepositAccountsRequest: PostFixedDepositAccountsRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<PostFixedDepositAccountsResponse>(`${this.configuration.basePath}/fixeddepositaccounts`,
    ...
    public template12(clientId?: number, groupId?: number, productId?: number, staffInSelectedOfficeOnly?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<GetFixedDepositAccountsTemplateResponse>(`${this.configuration.basePath}/fixeddepositaccounts/template`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public update15(accountId: number, putFixedDepositAccountsAccountIdRequest: PutFixedDepositAccountsAccountIdRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<PutFixedDepositAccountsAccountIdResponse>;
    public update15(accountId: number, putFixedDepositAccountsAccountIdRequest: PutFixedDepositAccountsAccountIdRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<PutFixedDepositAccountsAccountIdResponse>>;
    public update15(accountId: number, putFixedDepositAccountsAccountIdRequest: PutFixedDepositAccountsAccountIdRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<PutFixedDepositAccountsAccountIdResponse>>;
    public update15(accountId: number, putFixedDepositAccountsAccountIdRequest: PutFixedDepositAccountsAccountIdRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (accountId === null || accountId === undefined) {
        ...
        if (putFixedDepositAccountsAccountIdRequest === null || putFixedDepositAccountsAccountIdRequest === undefined) {
            throw new Error('Required parameter putFixedDepositAccountsAccountIdRequest was null or undefined when calling update15.');
        }
        ...
        return this.httpClient.put<PutFixedDepositAccountsAccountIdResponse>(`${this.configuration.basePath}/fixeddepositaccounts/${encodeURIComponent(String(accountId))}`,
