...
// @ts-ignore
import { GetAccountsTypeAccountIdResponse } from '../apache-fineract-client/models/getAccountsTypeAccountIdResponse';
// @ts-ignore
import { GetAccountsTypeResponse } from '../apache-fineract-client/models/getAccountsTypeResponse';
// @ts-ignore
import { GetAccountsTypeTemplateResponse } from '../apache-fineract-client/models/getAccountsTypeTemplateResponse';
// @ts-ignore
import { PostAccountsTypeAccountIdRequest } from '../apache-fineract-client/models/postAccountsTypeAccountIdRequest';
// @ts-ignore
import { PostAccountsTypeAccountIdResponse } from '../apache-fineract-client/models/postAccountsTypeAccountIdResponse';
// @ts-ignore
import { PostAccountsTypeRequest } from '../apache-fineract-client/models/postAccountsTypeRequest';
// @ts-ignore
import { PostAccountsTypeResponse } from '../apache-fineract-client/models/postAccountsTypeResponse';
// @ts-ignore
import { PutAccountsTypeAccountIdRequest } from '../apache-fineract-client/models/putAccountsTypeAccountIdRequest';
// @ts-ignore
import { PutAccountsTypeAccountIdResponse } from '../apache-fineract-client/models/putAccountsTypeAccountIdResponse';
...
export class ShareAccountService {
    ...
    public createAccount(type: string, postAccountsTypeRequest: PostAccountsTypeRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<PostAccountsTypeResponse>(`${this.configuration.basePath}/accounts/${encodeURIComponent(String(type))}`,
    ...
    public getSharedAccountsTemplate(type: string, officeId?: number, dateFormat?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/vnd.ms-excel', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.configuration.basePath}/accounts/${encodeURIComponent(String(type))}/downloadtemplate`,
            {
                context: localVarHttpContext,
    ...
    public handleCommands2(type: string, accountId: number, postAccountsTypeAccountIdRequest: PostAccountsTypeAccountIdRequest, command?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<PostAccountsTypeAccountIdResponse>(`${this.configuration.basePath}/accounts/${encodeURIComponent(String(type))}/${encodeURIComponent(String(accountId))}`,
    ...
    public postSharedAccountsTemplate(type: string, dateFormat?: string, locale?: string, uploadedInputStream?: Blob, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<string>(`${this.configuration.basePath}/accounts/${encodeURIComponent(String(type))}/uploadtemplate`,
    ...
    public retrieveAccount(accountId: number, type: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<GetAccountsTypeAccountIdResponse>(`${this.configuration.basePath}/accounts/${encodeURIComponent(String(type))}/${encodeURIComponent(String(accountId))}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public retrieveAllAccounts1(type: string, offset?: number, limit?: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<GetAccountsTypeResponse>(`${this.configuration.basePath}/accounts/${encodeURIComponent(String(type))}`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
    ...
    public template7(type: string, clientId?: number, productId?: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<GetAccountsTypeTemplateResponse>(`${this.configuration.basePath}/accounts/${encodeURIComponent(String(type))}/template`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
    ...
    public updateAccount(type: string, accountId: number, putAccountsTypeAccountIdRequest: PutAccountsTypeAccountIdRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.put<PutAccountsTypeAccountIdResponse>(`${this.configuration.basePath}/accounts/${encodeURIComponent(String(type))}/${encodeURIComponent(String(accountId))}`,
