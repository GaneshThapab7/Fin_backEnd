...
// @ts-ignore
import { PostLoansLoanIdScheduleResponse } from '../apache-fineract-client/models/postLoansLoanIdScheduleResponse';
...
export class LoanReschedulingService {
    ...
    public calculateLoanScheduleOrSubmitVariableSchedule(loanId: number, body: object, command?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<PostLoansLoanIdScheduleResponse>(`${this.configuration.basePath}/loans/${encodeURIComponent(String(loanId))}/schedule`,
            body,
            {
