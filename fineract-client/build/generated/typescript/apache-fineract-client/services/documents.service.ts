...
// @ts-ignore
import { DeleteEntityTypeEntityIdDocumentsResponse } from '../apache-fineract-client/models/deleteEntityTypeEntityIdDocumentsResponse';
// @ts-ignore
import { GetEntityTypeEntityIdDocumentsResponse } from '../apache-fineract-client/models/getEntityTypeEntityIdDocumentsResponse';
// @ts-ignore
import { PostEntityTypeEntityIdDocumentsResponse } from '../apache-fineract-client/models/postEntityTypeEntityIdDocumentsResponse';
// @ts-ignore
import { PutEntityTypeEntityIdDocumentsResponse } from '../apache-fineract-client/models/putEntityTypeEntityIdDocumentsResponse';
...
export class DocumentsService {
    ...
    public createDocument(entityType: string, entityId: number, contentLength?: number, dateFormat?: string, description?: string, locale?: string, name?: string, uploadedInputStream?: Blob, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<PostEntityTypeEntityIdDocumentsResponse>(`${this.configuration.basePath}/${encodeURIComponent(String(entityType))}/${encodeURIComponent(String(entityId))}/documents`,
    ...
    public deleteDocument(entityType: string, entityId: number, documentId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.delete<DeleteEntityTypeEntityIdDocumentsResponse>(`${this.configuration.basePath}/${encodeURIComponent(String(entityType))}/${encodeURIComponent(String(entityId))}/documents/${encodeURIComponent(String(documentId))}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public downloadFile(entityType: string, entityId: number, documentId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.configuration.basePath}/${encodeURIComponent(String(entityType))}/${encodeURIComponent(String(entityId))}/documents/${encodeURIComponent(String(documentId))}/attachment`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public getDocument(entityType: string, entityId: number, documentId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<GetEntityTypeEntityIdDocumentsResponse>(`${this.configuration.basePath}/${encodeURIComponent(String(entityType))}/${encodeURIComponent(String(entityId))}/documents/${encodeURIComponent(String(documentId))}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public retrieveAllDocuments(entityType: string, entityId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<Array<GetEntityTypeEntityIdDocumentsResponse>>(`${this.configuration.basePath}/${encodeURIComponent(String(entityType))}/${encodeURIComponent(String(entityId))}/documents`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public updateDocument(entityType: string, entityId: number, documentId: number, contentLength?: number, dateFormat?: string, description?: string, locale?: string, name?: string, uploadedInputStream?: Blob, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.put<PutEntityTypeEntityIdDocumentsResponse>(`${this.configuration.basePath}/${encodeURIComponent(String(entityType))}/${encodeURIComponent(String(entityId))}/documents/${encodeURIComponent(String(documentId))}`,
            localVarConvertFormParamsToString ? localVarFormParams.toString() : localVarFormParams,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
