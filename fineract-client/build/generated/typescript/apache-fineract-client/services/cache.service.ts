...
// @ts-ignore
import { GetCachesResponse } from '../apache-fineract-client/models/getCachesResponse';
// @ts-ignore
import { PutCachesRequest } from '../apache-fineract-client/models/putCachesRequest';
// @ts-ignore
import { PutCachesResponse } from '../apache-fineract-client/models/putCachesResponse';
...
export class CacheService {
    ...
    public retrieveAll4(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<Array<GetCachesResponse>>(`${this.configuration.basePath}/caches`,
            {
    ...
    public switchCache(putCachesRequest: PutCachesRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.put<PutCachesResponse>(`${this.configuration.basePath}/caches`,
            putCachesRequest,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
