...
// @ts-ignore
import { DeleteGroupsGroupIdResponse } from '../apache-fineract-client/models/deleteGroupsGroupIdResponse';
// @ts-ignore
import { GetGroupsGroupIdAccountsResponse } from '../apache-fineract-client/models/getGroupsGroupIdAccountsResponse';
// @ts-ignore
import { GetGroupsGroupIdResponse } from '../apache-fineract-client/models/getGroupsGroupIdResponse';
// @ts-ignore
import { GetGroupsResponse } from '../apache-fineract-client/models/getGroupsResponse';
// @ts-ignore
import { GetGroupsTemplateResponse } from '../apache-fineract-client/models/getGroupsTemplateResponse';
// @ts-ignore
import { PostGroupsGroupIdCommandUnassignStaffRequest } from '../apache-fineract-client/models/postGroupsGroupIdCommandUnassignStaffRequest';
// @ts-ignore
import { PostGroupsGroupIdCommandUnassignStaffResponse } from '../apache-fineract-client/models/postGroupsGroupIdCommandUnassignStaffResponse';
// @ts-ignore
import { PostGroupsGroupIdRequest } from '../apache-fineract-client/models/postGroupsGroupIdRequest';
// @ts-ignore
import { PostGroupsGroupIdResponse } from '../apache-fineract-client/models/postGroupsGroupIdResponse';
// @ts-ignore
import { PostGroupsRequest } from '../apache-fineract-client/models/postGroupsRequest';
// @ts-ignore
import { PostGroupsResponse } from '../apache-fineract-client/models/postGroupsResponse';
// @ts-ignore
import { PutGroupsGroupIdRequest } from '../apache-fineract-client/models/putGroupsGroupIdRequest';
// @ts-ignore
import { PutGroupsGroupIdResponse } from '../apache-fineract-client/models/putGroupsGroupIdResponse';
...
export class GroupsService {
    ...
    public activateOrGenerateCollectionSheet(groupId: number, postGroupsGroupIdRequest: PostGroupsGroupIdRequest, command?: string, roleId?: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<PostGroupsGroupIdResponse>(`${this.configuration.basePath}/groups/${encodeURIComponent(String(groupId))}`,
    ...
    public create8(postGroupsRequest: PostGroupsRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<PostGroupsResponse>(`${this.configuration.basePath}/groups`,
            postGroupsRequest,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public delete11(groupId: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<DeleteGroupsGroupIdResponse>;
    public delete11(groupId: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<DeleteGroupsGroupIdResponse>>;
    public delete11(groupId: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<DeleteGroupsGroupIdResponse>>;
    public delete11(groupId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (groupId === null || groupId === undefined) {
        ...
        return this.httpClient.delete<DeleteGroupsGroupIdResponse>(`${this.configuration.basePath}/groups/${encodeURIComponent(String(groupId))}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public getGroupsTemplate(officeId?: number, staffId?: number, dateFormat?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/vnd.ms-excel', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.configuration.basePath}/groups/downloadtemplate`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
    ...
    public postGroupTemplate(dateFormat?: string, locale?: string, uploadedInputStream?: Blob, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<string>(`${this.configuration.basePath}/groups/uploadtemplate`,
    ...
    public retrieveAccounts(groupId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<GetGroupsGroupIdAccountsResponse>(`${this.configuration.basePath}/groups/${encodeURIComponent(String(groupId))}/accounts`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public retrieveAll24(officeId?: number, staffId?: number, externalId?: string, name?: string, underHierarchy?: string, paged?: boolean, offset?: number, limit?: number, orderBy?: string, sortOrder?: string, orphansOnly?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<GetGroupsResponse>(`${this.configuration.basePath}/groups`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
    ...
    public retrieveGsimAccounts(groupId: number, parentGSIMAccountNo?: string, parentGSIMId?: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<string>(`${this.configuration.basePath}/groups/${encodeURIComponent(String(groupId))}/gsimaccounts`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public retrieveOne14(groupId: number, staffInSelectedOfficeOnly?: boolean, roleId?: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<GetGroupsGroupIdResponse>;
    public retrieveOne14(groupId: number, staffInSelectedOfficeOnly?: boolean, roleId?: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<GetGroupsGroupIdResponse>>;
    public retrieveOne14(groupId: number, staffInSelectedOfficeOnly?: boolean, roleId?: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<GetGroupsGroupIdResponse>>;
    public retrieveOne14(groupId: number, staffInSelectedOfficeOnly?: boolean, roleId?: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (groupId === null || groupId === undefined) {
        ...
        return this.httpClient.get<GetGroupsGroupIdResponse>(`${this.configuration.basePath}/groups/${encodeURIComponent(String(groupId))}`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
    ...
    public retrieveTemplate7(officeId?: number, center?: boolean, centerId?: number, command?: string, staffInSelectedOfficeOnly?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<GetGroupsTemplateResponse>(`${this.configuration.basePath}/groups/template`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
    ...
    public retrieveglimAccounts(groupId: number, parentLoanAccountNo?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<string>(`${this.configuration.basePath}/groups/${encodeURIComponent(String(groupId))}/glimaccounts`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
    ...
    public unassignLoanOfficer(groupId: number, postGroupsGroupIdCommandUnassignStaffRequest: PostGroupsGroupIdCommandUnassignStaffRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<PostGroupsGroupIdCommandUnassignStaffResponse>(`${this.configuration.basePath}/groups/${encodeURIComponent(String(groupId))}/command/unassign_staff`,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public update12(groupId: number, putGroupsGroupIdRequest: PutGroupsGroupIdRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<PutGroupsGroupIdResponse>;
    public update12(groupId: number, putGroupsGroupIdRequest: PutGroupsGroupIdRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<PutGroupsGroupIdResponse>>;
    public update12(groupId: number, putGroupsGroupIdRequest: PutGroupsGroupIdRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<PutGroupsGroupIdResponse>>;
    public update12(groupId: number, putGroupsGroupIdRequest: PutGroupsGroupIdRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (groupId === null || groupId === undefined) {
        ...
        return this.httpClient.put<PutGroupsGroupIdResponse>(`${this.configuration.basePath}/groups/${encodeURIComponent(String(groupId))}`,
