...
// @ts-ignore
import { PostSavingsAccountBulkReversalTransactionsRequest } from '../apache-fineract-client/models/postSavingsAccountBulkReversalTransactionsRequest';
// @ts-ignore
import { PostSavingsAccountTransactionsRequest } from '../apache-fineract-client/models/postSavingsAccountTransactionsRequest';
// @ts-ignore
import { PostSavingsAccountTransactionsResponse } from '../apache-fineract-client/models/postSavingsAccountTransactionsResponse';
...
export class SavingsAccountTransactionsService {
    ...
    public adjustTransaction1(savingsId: number, transactionId: number, postSavingsAccountBulkReversalTransactionsRequest: PostSavingsAccountBulkReversalTransactionsRequest, command?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<Array<PostSavingsAccountBulkReversalTransactionsRequest>>(`${this.configuration.basePath}/savingsaccounts/${encodeURIComponent(String(savingsId))}/transactions/${encodeURIComponent(String(transactionId))}`,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public retrieveOne23(savingsId: number, transactionId: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<string>;
    public retrieveOne23(savingsId: number, transactionId: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<string>>;
    public retrieveOne23(savingsId: number, transactionId: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<string>>;
    public retrieveOne23(savingsId: number, transactionId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (savingsId === null || savingsId === undefined) {
        ...
        return this.httpClient.get<string>(`${this.configuration.basePath}/savingsaccounts/${encodeURIComponent(String(savingsId))}/transactions/${encodeURIComponent(String(transactionId))}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public retrieveTemplate18(savingsId: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<string>;
    public retrieveTemplate18(savingsId: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<string>>;
    public retrieveTemplate18(savingsId: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<string>>;
    public retrieveTemplate18(savingsId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (savingsId === null || savingsId === undefined) {
        ...
        return this.httpClient.get<string>(`${this.configuration.basePath}/savingsaccounts/${encodeURIComponent(String(savingsId))}/transactions/template`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public transaction2(savingsId: number, postSavingsAccountTransactionsRequest: PostSavingsAccountTransactionsRequest, command?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<PostSavingsAccountTransactionsResponse>(`${this.configuration.basePath}/savingsaccounts/${encodeURIComponent(String(savingsId))}/transactions`,
