...
// @ts-ignore
import { DeleteCentersCenterIdResponse } from '../apache-fineract-client/models/deleteCentersCenterIdResponse';
// @ts-ignore
import { GetCentersCenterIdAccountsResponse } from '../apache-fineract-client/models/getCentersCenterIdAccountsResponse';
// @ts-ignore
import { GetCentersCenterIdResponse } from '../apache-fineract-client/models/getCentersCenterIdResponse';
// @ts-ignore
import { GetCentersResponse } from '../apache-fineract-client/models/getCentersResponse';
// @ts-ignore
import { GetCentersTemplateResponse } from '../apache-fineract-client/models/getCentersTemplateResponse';
// @ts-ignore
import { PostCentersCenterIdRequest } from '../apache-fineract-client/models/postCentersCenterIdRequest';
// @ts-ignore
import { PostCentersCenterIdResponse } from '../apache-fineract-client/models/postCentersCenterIdResponse';
// @ts-ignore
import { PostCentersRequest } from '../apache-fineract-client/models/postCentersRequest';
// @ts-ignore
import { PostCentersResponse } from '../apache-fineract-client/models/postCentersResponse';
// @ts-ignore
import { PutCentersCenterIdRequest } from '../apache-fineract-client/models/putCentersCenterIdRequest';
// @ts-ignore
import { PutCentersCenterIdResponse } from '../apache-fineract-client/models/putCentersCenterIdResponse';
...
export class CentersService {
    ...
    public activate2(centerId: number, postCentersCenterIdRequest: PostCentersCenterIdRequest, command?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<PostCentersCenterIdResponse>(`${this.configuration.basePath}/centers/${encodeURIComponent(String(centerId))}`,
    ...
    public create7(postCentersRequest: PostCentersRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<PostCentersResponse>(`${this.configuration.basePath}/centers`,
            postCentersRequest,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public delete10(centerId: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<DeleteCentersCenterIdResponse>;
    public delete10(centerId: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<DeleteCentersCenterIdResponse>>;
    public delete10(centerId: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<DeleteCentersCenterIdResponse>>;
    public delete10(centerId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (centerId === null || centerId === undefined) {
        ...
        return this.httpClient.delete<DeleteCentersCenterIdResponse>(`${this.configuration.basePath}/centers/${encodeURIComponent(String(centerId))}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public getCentersTemplate(officeId?: number, staffId?: number, dateFormat?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/vnd.ms-excel', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.configuration.basePath}/centers/downloadtemplate`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
    ...
    public postCentersTemplate(dateFormat?: string, locale?: string, uploadedInputStream?: Blob, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<string>(`${this.configuration.basePath}/centers/uploadtemplate`,
    ...
    public retrieveAll23(officeId?: number, staffId?: number, externalId?: string, name?: string, underHierarchy?: string, paged?: boolean, offset?: number, limit?: number, orderBy?: string, sortOrder?: string, meetingDate?: object, dateFormat?: string, locale?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<GetCentersResponse>(`${this.configuration.basePath}/centers`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
    ...
    public retrieveGroupAccount(centerId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<GetCentersCenterIdAccountsResponse>(`${this.configuration.basePath}/centers/${encodeURIComponent(String(centerId))}/accounts`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public retrieveOne13(centerId: number, staffInSelectedOfficeOnly?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<GetCentersCenterIdResponse>;
    public retrieveOne13(centerId: number, staffInSelectedOfficeOnly?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<GetCentersCenterIdResponse>>;
    public retrieveOne13(centerId: number, staffInSelectedOfficeOnly?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<GetCentersCenterIdResponse>>;
    public retrieveOne13(centerId: number, staffInSelectedOfficeOnly?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (centerId === null || centerId === undefined) {
        ...
        return this.httpClient.get<GetCentersCenterIdResponse>(`${this.configuration.basePath}/centers/${encodeURIComponent(String(centerId))}`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
    ...
    public retrieveTemplate6(command?: string, officeId?: number, staffInSelectedOfficeOnly?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<GetCentersTemplateResponse>(`${this.configuration.basePath}/centers/template`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public update11(centerId: number, putCentersCenterIdRequest: PutCentersCenterIdRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<PutCentersCenterIdResponse>;
    public update11(centerId: number, putCentersCenterIdRequest: PutCentersCenterIdRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<PutCentersCenterIdResponse>>;
    public update11(centerId: number, putCentersCenterIdRequest: PutCentersCenterIdRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<PutCentersCenterIdResponse>>;
    public update11(centerId: number, putCentersCenterIdRequest: PutCentersCenterIdRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (centerId === null || centerId === undefined) {
        ...
        return this.httpClient.put<PutCentersCenterIdResponse>(`${this.configuration.basePath}/centers/${encodeURIComponent(String(centerId))}`,
