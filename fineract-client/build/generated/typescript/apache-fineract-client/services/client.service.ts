...
// @ts-ignore
import { DeleteClientsClientIdResponse } from '../apache-fineract-client/models/deleteClientsClientIdResponse';
// @ts-ignore
import { GetClientsClientIdAccountsResponse } from '../apache-fineract-client/models/getClientsClientIdAccountsResponse';
// @ts-ignore
import { GetClientsClientIdResponse } from '../apache-fineract-client/models/getClientsClientIdResponse';
// @ts-ignore
import { GetClientsResponse } from '../apache-fineract-client/models/getClientsResponse';
// @ts-ignore
import { GetClientsTemplateResponse } from '../apache-fineract-client/models/getClientsTemplateResponse';
// @ts-ignore
import { PostClientsClientIdRequest } from '../apache-fineract-client/models/postClientsClientIdRequest';
// @ts-ignore
import { PostClientsClientIdResponse } from '../apache-fineract-client/models/postClientsClientIdResponse';
// @ts-ignore
import { PostClientsRequest } from '../apache-fineract-client/models/postClientsRequest';
// @ts-ignore
import { PostClientsResponse } from '../apache-fineract-client/models/postClientsResponse';
// @ts-ignore
import { PutClientsClientIdRequest } from '../apache-fineract-client/models/putClientsClientIdRequest';
// @ts-ignore
import { PutClientsClientIdResponse } from '../apache-fineract-client/models/putClientsClientIdResponse';
...
export class ClientService {
    ...
    public activate1(clientId: number, postClientsClientIdRequest: PostClientsClientIdRequest, command?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<PostClientsClientIdResponse>(`${this.configuration.basePath}/clients/${encodeURIComponent(String(clientId))}`,
    ...
    public create6(postClientsRequest: PostClientsRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<PostClientsResponse>(`${this.configuration.basePath}/clients`,
            postClientsRequest,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
    ...
    public delete9(clientId: number, body: object, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.delete<DeleteClientsClientIdResponse>(`${this.configuration.basePath}/clients/${encodeURIComponent(String(clientId))}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public getClientTemplate(legalFormType?: string, officeId?: number, staffId?: number, dateFormat?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/vnd.ms-excel', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.configuration.basePath}/clients/downloadtemplate`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
    ...
    public postClientTemplate(legalFormType?: string, dateFormat?: string, locale?: string, uploadedInputStream?: Blob, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<string>(`${this.configuration.basePath}/clients/uploadtemplate`,
    ...
    public retrieveAll21(sqlSearch?: string, officeId?: number, externalId?: string, displayName?: string, firstName?: string, lastName?: string, status?: string, underHierarchy?: string, offset?: number, limit?: number, orderBy?: string, sortOrder?: string, orphansOnly?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<GetClientsResponse>(`${this.configuration.basePath}/clients`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
    ...
    public retrieveAssociatedAccounts(clientId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<GetClientsClientIdAccountsResponse>(`${this.configuration.basePath}/clients/${encodeURIComponent(String(clientId))}/accounts`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public retrieveObligeeDetails(clientId: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<string>;
    public retrieveObligeeDetails(clientId: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<string>>;
    public retrieveObligeeDetails(clientId: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<string>>;
    public retrieveObligeeDetails(clientId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<string>(`${this.configuration.basePath}/clients/${encodeURIComponent(String(clientId))}/obligeedetails`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public retrieveOne11(clientId: number, staffInSelectedOfficeOnly?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<GetClientsClientIdResponse>(`${this.configuration.basePath}/clients/${encodeURIComponent(String(clientId))}`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
    ...
    public retrieveTemplate5(officeId?: number, commandParam?: string, staffInSelectedOfficeOnly?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<GetClientsTemplateResponse>(`${this.configuration.basePath}/clients/template`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public retrieveTransferTemplate(clientId: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<string>;
    public retrieveTransferTemplate(clientId: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<string>>;
    public retrieveTransferTemplate(clientId: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<string>>;
    public retrieveTransferTemplate(clientId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<string>(`${this.configuration.basePath}/clients/${encodeURIComponent(String(clientId))}/transferproposaldate`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public update10(clientId: number, putClientsClientIdRequest: PutClientsClientIdRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.put<PutClientsClientIdResponse>(`${this.configuration.basePath}/clients/${encodeURIComponent(String(clientId))}`,
