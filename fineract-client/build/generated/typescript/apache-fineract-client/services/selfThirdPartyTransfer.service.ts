...
// @ts-ignore
import { DeleteSelfBeneficiariesTPTBeneficiaryIdResponse } from '../apache-fineract-client/models/deleteSelfBeneficiariesTPTBeneficiaryIdResponse';
// @ts-ignore
import { GetSelfBeneficiariesTPTResponse } from '../apache-fineract-client/models/getSelfBeneficiariesTPTResponse';
// @ts-ignore
import { GetSelfBeneficiariesTPTTemplateResponse } from '../apache-fineract-client/models/getSelfBeneficiariesTPTTemplateResponse';
// @ts-ignore
import { PostSelfBeneficiariesTPTRequest } from '../apache-fineract-client/models/postSelfBeneficiariesTPTRequest';
// @ts-ignore
import { PostSelfBeneficiariesTPTResponse } from '../apache-fineract-client/models/postSelfBeneficiariesTPTResponse';
// @ts-ignore
import { PutSelfBeneficiariesTPTBeneficiaryIdRequest } from '../apache-fineract-client/models/putSelfBeneficiariesTPTBeneficiaryIdRequest';
// @ts-ignore
import { PutSelfBeneficiariesTPTBeneficiaryIdResponse } from '../apache-fineract-client/models/putSelfBeneficiariesTPTBeneficiaryIdResponse';
...
export class SelfThirdPartyTransferService {
    ...
    public add(postSelfBeneficiariesTPTRequest: PostSelfBeneficiariesTPTRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<PostSelfBeneficiariesTPTResponse>(`${this.configuration.basePath}/self/beneficiaries/tpt`,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public delete20(beneficiaryId: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<DeleteSelfBeneficiariesTPTBeneficiaryIdResponse>;
    public delete20(beneficiaryId: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<DeleteSelfBeneficiariesTPTBeneficiaryIdResponse>>;
    public delete20(beneficiaryId: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<DeleteSelfBeneficiariesTPTBeneficiaryIdResponse>>;
    public delete20(beneficiaryId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.delete<DeleteSelfBeneficiariesTPTBeneficiaryIdResponse>(`${this.configuration.basePath}/self/beneficiaries/tpt/${encodeURIComponent(String(beneficiaryId))}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public retrieveAll35(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<Array<GetSelfBeneficiariesTPTResponse>>(`${this.configuration.basePath}/self/beneficiaries/tpt`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public template16(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<GetSelfBeneficiariesTPTTemplateResponse>(`${this.configuration.basePath}/self/beneficiaries/tpt/template`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public update21(beneficiaryId: number, putSelfBeneficiariesTPTBeneficiaryIdRequest: PutSelfBeneficiariesTPTBeneficiaryIdRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<PutSelfBeneficiariesTPTBeneficiaryIdResponse>;
    public update21(beneficiaryId: number, putSelfBeneficiariesTPTBeneficiaryIdRequest: PutSelfBeneficiariesTPTBeneficiaryIdRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<PutSelfBeneficiariesTPTBeneficiaryIdResponse>>;
    public update21(beneficiaryId: number, putSelfBeneficiariesTPTBeneficiaryIdRequest: PutSelfBeneficiariesTPTBeneficiaryIdRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<PutSelfBeneficiariesTPTBeneficiaryIdResponse>>;
    public update21(beneficiaryId: number, putSelfBeneficiariesTPTBeneficiaryIdRequest: PutSelfBeneficiariesTPTBeneficiaryIdRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (beneficiaryId === null || beneficiaryId === undefined) {
        ...
        if (putSelfBeneficiariesTPTBeneficiaryIdRequest === null || putSelfBeneficiariesTPTBeneficiaryIdRequest === undefined) {
            throw new Error('Required parameter putSelfBeneficiariesTPTBeneficiaryIdRequest was null or undefined when calling update21.');
        }
        ...
        return this.httpClient.put<PutSelfBeneficiariesTPTBeneficiaryIdResponse>(`${this.configuration.basePath}/self/beneficiaries/tpt/${encodeURIComponent(String(beneficiaryId))}`,
