...
// @ts-ignore
import { RunReportsResponse } from '../apache-fineract-client/models/runReportsResponse';
...
export class RunReportsService {
    ...
    public runReport(reportName: string, isSelfServiceUserReport?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'application/pdf' | 'application/vnd.ms-excel' | 'text/csv' | 'text/html', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<RunReportsResponse>(`${this.configuration.basePath}/runreports/${encodeURIComponent(String(reportName))}`,
            {
