...
// @ts-ignore
import { DeleteUsersUserIdResponse } from '../apache-fineract-client/models/deleteUsersUserIdResponse';
// @ts-ignore
import { GetUsersResponse } from '../apache-fineract-client/models/getUsersResponse';
// @ts-ignore
import { GetUsersTemplateResponse } from '../apache-fineract-client/models/getUsersTemplateResponse';
// @ts-ignore
import { GetUsersUserIdResponse } from '../apache-fineract-client/models/getUsersUserIdResponse';
// @ts-ignore
import { PostUsersRequest } from '../apache-fineract-client/models/postUsersRequest';
// @ts-ignore
import { PostUsersResponse } from '../apache-fineract-client/models/postUsersResponse';
// @ts-ignore
import { PutUsersUserIdRequest } from '../apache-fineract-client/models/putUsersUserIdRequest';
// @ts-ignore
import { PutUsersUserIdResponse } from '../apache-fineract-client/models/putUsersUserIdResponse';
...
export class UsersService {
    ...
    public create15(postUsersRequest: PostUsersRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<PostUsersResponse>(`${this.configuration.basePath}/users`,
            postUsersRequest,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public delete21(userId: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<DeleteUsersUserIdResponse>;
    public delete21(userId: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<DeleteUsersUserIdResponse>>;
    public delete21(userId: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<DeleteUsersUserIdResponse>>;
    public delete21(userId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.delete<DeleteUsersUserIdResponse>(`${this.configuration.basePath}/users/${encodeURIComponent(String(userId))}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public getUserTemplate(officeId?: number, staffId?: number, dateFormat?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/vnd.ms-excel', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.configuration.basePath}/users/downloadtemplate`,
            {
                context: localVarHttpContext,
    ...
    public postUsersTemplate(dateFormat?: string, locale?: string, uploadedInputStream?: Blob, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<string>(`${this.configuration.basePath}/users/uploadtemplate`,
    ...
    public retrieveAll41(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<Array<GetUsersResponse>>(`${this.configuration.basePath}/users`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public retrieveOne29(userId: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<GetUsersUserIdResponse>;
    public retrieveOne29(userId: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<GetUsersUserIdResponse>>;
    public retrieveOne29(userId: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<GetUsersUserIdResponse>>;
    public retrieveOne29(userId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (userId === null || userId === undefined) {
        ...
        return this.httpClient.get<GetUsersUserIdResponse>(`${this.configuration.basePath}/users/${encodeURIComponent(String(userId))}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public template22(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<GetUsersTemplateResponse>(`${this.configuration.basePath}/users/template`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public update24(userId: number, putUsersUserIdRequest: PutUsersUserIdRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<PutUsersUserIdResponse>;
    public update24(userId: number, putUsersUserIdRequest: PutUsersUserIdRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<PutUsersUserIdResponse>>;
    public update24(userId: number, putUsersUserIdRequest: PutUsersUserIdRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<PutUsersUserIdResponse>>;
    public update24(userId: number, putUsersUserIdRequest: PutUsersUserIdRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (userId === null || userId === undefined) {
        ...
        return this.httpClient.put<PutUsersUserIdResponse>(`${this.configuration.basePath}/users/${encodeURIComponent(String(userId))}`,
