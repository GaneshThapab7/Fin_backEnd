...
// @ts-ignore
import { JournalEntryCommand } from '../apache-fineract-client/models/journalEntryCommand';
// @ts-ignore
import { JournalEntryData } from '../apache-fineract-client/models/journalEntryData';
// @ts-ignore
import { PostJournalEntriesResponse } from '../apache-fineract-client/models/postJournalEntriesResponse';
// @ts-ignore
import { PostJournalEntriesTransactionIdRequest } from '../apache-fineract-client/models/postJournalEntriesTransactionIdRequest';
// @ts-ignore
import { PostJournalEntriesTransactionIdResponse } from '../apache-fineract-client/models/postJournalEntriesTransactionIdResponse';
...
export class JournalEntriesService {
    ...
    public createGLJournalEntry(command?: string, journalEntryCommand?: JournalEntryCommand, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<PostJournalEntriesResponse>(`${this.configuration.basePath}/journalentries`,
            journalEntryCommand,
            {
    ...
    public createReversalJournalEntry(transactionId: string, command?: string, postJournalEntriesTransactionIdRequest?: PostJournalEntriesTransactionIdRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<PostJournalEntriesTransactionIdResponse>(`${this.configuration.basePath}/journalentries/${encodeURIComponent(String(transactionId))}`,
    ...
    public getJournalEntriesTemplate(officeId?: number, dateFormat?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/vnd.ms-excel', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.configuration.basePath}/journalentries/downloadtemplate`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
    ...
    public postJournalEntriesTemplate(dateFormat?: string, locale?: string, uploadedInputStream?: Blob, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.post<string>(`${this.configuration.basePath}/journalentries/uploadtemplate`,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public retreiveJournalEntryById(journalEntryId: number, runningBalance?: boolean, transactionDetails?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<JournalEntryData>;
    public retreiveJournalEntryById(journalEntryId: number, runningBalance?: boolean, transactionDetails?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<JournalEntryData>>;
    public retreiveJournalEntryById(journalEntryId: number, runningBalance?: boolean, transactionDetails?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<JournalEntryData>>;
    public retreiveJournalEntryById(journalEntryId: number, runningBalance?: boolean, transactionDetails?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<JournalEntryData>(`${this.configuration.basePath}/journalentries/${encodeURIComponent(String(journalEntryId))}`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public retrieveAll1(officeId?: number, glAccountId?: number, manualEntriesOnly?: boolean, fromDate?: object, toDate?: object, transactionId?: string, entityType?: number, offset?: number, limit?: number, orderBy?: string, sortOrder?: string, locale?: string, dateFormat?: string, loanId?: number, savingsId?: number, runningBalance?: boolean, transactionDetails?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<Array<JournalEntryData>>;
    public retrieveAll1(officeId?: number, glAccountId?: number, manualEntriesOnly?: boolean, fromDate?: object, toDate?: object, transactionId?: string, entityType?: number, offset?: number, limit?: number, orderBy?: string, sortOrder?: string, locale?: string, dateFormat?: string, loanId?: number, savingsId?: number, runningBalance?: boolean, transactionDetails?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<Array<JournalEntryData>>>;
    public retrieveAll1(officeId?: number, glAccountId?: number, manualEntriesOnly?: boolean, fromDate?: object, toDate?: object, transactionId?: string, entityType?: number, offset?: number, limit?: number, orderBy?: string, sortOrder?: string, locale?: string, dateFormat?: string, loanId?: number, savingsId?: number, runningBalance?: boolean, transactionDetails?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<Array<JournalEntryData>>>;
    public retrieveAll1(officeId?: number, glAccountId?: number, manualEntriesOnly?: boolean, fromDate?: object, toDate?: object, transactionId?: string, entityType?: number, offset?: number, limit?: number, orderBy?: string, sortOrder?: string, locale?: string, dateFormat?: string, loanId?: number, savingsId?: number, runningBalance?: boolean, transactionDetails?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<Array<JournalEntryData>>(`${this.configuration.basePath}/journalentries`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
    ...
    public retrieveJournalEntries(offset?: number, limit?: number, entryId?: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<string>(`${this.configuration.basePath}/journalentries/provisioning`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
    ...
    public retrieveOpeningBalance(officeId?: number, currencyCode?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<string>(`${this.configuration.basePath}/journalentries/openingbalance`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
