...
public class GetLoanProductsResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountingRule, amortizationType, annualInterestRate, currency, daysInMonthType, daysInYearType, endDate, fixedPrincipalPercentagePerInstallment, id, includeInBorrowerCycle, interestCalculationPeriodType, interestRateFrequencyType, interestRatePerPeriod, interestRateVariationsForBorrowerCycle, interestRecalculationData, interestType, isInterestRecalculationEnabled, maxNumberOfRepayments, maxPrincipal, minNumberOfRepayments, minPrincipal, name, numberOfRepaymentVariationsForBorrowerCycle, numberOfRepayments, principal, principalThresholdForLastInstalment, principalVariationsForBorrowerCycle, repaymentEvery, repaymentFrequencyType, shortName, startDate, status, transactionProcessingStrategyId, transactionProcessingStrategyName, useBorrowerCycle);
  }
