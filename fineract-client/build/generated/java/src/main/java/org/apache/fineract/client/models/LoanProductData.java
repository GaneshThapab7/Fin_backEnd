...
public class LoanProductData {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowPartialPeriodInterestCalcualtion, loanProductData.allowPartialPeriodInterestCalcualtion) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowPartialPeriodInterestCalcualtion, amortizationType, amortizationTypeOptions, annualInterestRate, chargeOptions, closeDate, compoundingToBePostedAsTransaction, currency, daysInMonthType, daysInYearType, defaultDifferentialLendingRate, description, equalAmortization, fixedPrincipalPercentagePerInstallment, floatingInterestRateCalculationAllowed, fundId, fundName, fundOptions, getloanProductConfigurableAttributes, graceOnArrearsAgeing, graceOnInterestCharged, graceOnInterestPayment, graceOnPrincipalPayment, id, inArrearsTolerance, interestCalculationPeriodType, interestCalculationPeriodTypeOptions, interestRateDifferential, interestRateFrequencyType, interestRateFrequencyTypeOptions, interestRatePerPeriod, interestRateVariationsForBorrowerCycle, interestRecalculationData, interestRecalculationEnabled, interestType, interestTypeOptions, linkedToFloatingInterestRates, maxDifferentialLendingRate, maxInterestRatePerPeriod, maxNumberOfRepayments, maxPrincipal, maximumGapBetweenInstallments, minDifferentialLendingRate, minInterestRatePerPeriod, minNumberOfRepayments, minPrincipal, minimumGapBetweenInstallments, multiDisburseLoan, name, numberOfRepaymentVariationsForBorrowerCycle, numberOfRepayments, outstandingLoanBalance, principal, principalVariationsForBorrowerCycle, recurringMoratoriumOnPrincipalPeriods, repaymentEvery, repaymentFrequencyType, repaymentFrequencyTypeOptions, startDate, transactionProcessingStrategyId, transactionProcessingStrategyName, variableInstallmentsAllowed);
  }
