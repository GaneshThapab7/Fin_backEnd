...
import org.apache.fineract.client.models.PutClientsClientIdResponse;
    ...
    public interface ClientApi {
        ...
        */
        ...
        @retrofit2.http.Query("legalFormType") String legalFormType, @retrofit2.http.Part("dateFormat") String dateFormat, @retrofit2.http.Part("locale") String locale, @retrofit2.http.Part MultipartBody.Part uploadedInputStream
                );
