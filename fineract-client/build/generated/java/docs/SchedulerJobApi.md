...
|------------- | ------------- | -------------|
| [**executeJob**](SchedulerJobApi.md#executeJob) | **POST** jobs/{jobId} | Run a Job |
| [**retrieveAll8**](SchedulerJobApi.md#retrieveAll8) | **GET** jobs | Retrieve Scheduler Jobs |
| [**retrieveHistory**](SchedulerJobApi.md#retrieveHistory) | **GET** jobs/{jobId}/runhistory | Retrieve Job Run History |
| [**retrieveOne5**](SchedulerJobApi.md#retrieveOne5) | **GET** jobs/{jobId} | Retrieve a Job |
| [**updateJobDetail**](SchedulerJobApi.md#updateJobDetail) | **PUT** jobs/{jobId} | Update a Job |
...
public class Example {
    public static void main(String[] args) {
        ...
        SchedulerJobApi apiInstance = new SchedulerJobApi(defaultClient);
        Long jobId = 56L; // Long | jobId
        String command = "command_example"; // String | command
        try {
            apiInstance.executeJob(jobId, command);
        } catch (ApiException e) {
            System.err.println("Exception when calling SchedulerJobApi#executeJob");
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling SchedulerJobApi#retrieveAll8");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling SchedulerJobApi#retrieveHistory");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling SchedulerJobApi#retrieveOne5");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling SchedulerJobApi#updateJobDetail");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
