...
> String postGuarantorTemplate(loanId, dateFormat, locale, uploadedInputStream)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            String result = apiInstance.postGuarantorTemplate(loanId, dateFormat, locale, uploadedInputStream);
            System.out.println(result);
        } catch (ApiException e) {
