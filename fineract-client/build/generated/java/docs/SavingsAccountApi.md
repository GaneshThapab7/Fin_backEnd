...
> String postSavingsTemplate(dateFormat, locale, uploadedInputStream)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            String result = apiInstance.postSavingsTemplate(dateFormat, locale, uploadedInputStream);
            System.out.println(result);
        } catch (ApiException e) {
...
> String postSavingsTransactionTemplate(dateFormat, locale, uploadedInputStream)
...
public class Example {
    public static void main(String[] args) {
        ...
        File uploadedInputStream = new File("/path/to/file"); // File | 
        try {
            String result = apiInstance.postSavingsTransactionTemplate(dateFormat, locale, uploadedInputStream);
            System.out.println(result);
        } catch (ApiException e) {
