...
> String postLoanRepaymentTemplate(dateFormat, locale, uploadedInputStream)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            String result = apiInstance.postLoanRepaymentTemplate(dateFormat, locale, uploadedInputStream);
            System.out.println(result);
        } catch (ApiException e) {
...
> String postLoanTemplate(dateFormat, locale, uploadedInputStream)
...
public class Example {
    public static void main(String[] args) {
        ...
        File uploadedInputStream = new File("/path/to/file"); // File | 
        try {
            String result = apiInstance.postLoanTemplate(dateFormat, locale, uploadedInputStream);
            System.out.println(result);
        } catch (ApiException e) {
...
> GetLoansLoanIdResponse retrieveLoan(loanId, staffInSelectedOfficeOnly, associations, exclude, fields)
...
public class Example {
    public static void main(String[] args) {
        ...
        String associations = "all"; // String | Loan object relations to be included in the response
        String exclude = "guarantors,futureSchedule"; // String | Optional Loan object relation list to be filtered in the response
        String fields = "id,principal,annualInterestRate"; // String | Optional Loan attribute list to be in the response
        try {
            GetLoansLoanIdResponse result = apiInstance.retrieveLoan(loanId, staffInSelectedOfficeOnly, associations, exclude, fields);
            System.out.println(result);
        } catch (ApiException e) {
...
| **associations** | **String**| Loan object relations to be included in the response | [optional] [default to all] |
| **exclude** | **String**| Optional Loan object relation list to be filtered in the response | [optional] |
| **fields** | **String**| Optional Loan attribute list to be in the response | [optional] |
